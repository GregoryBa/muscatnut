...
public class ApiKeyAuthHandler : AuthenticationHandler<ApiKeyAuthSchemeOptions>
{
    ...
    protected override Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        {
            return Task.FromResult(AuthenticateResult.Fail("Need API Key"));
        }
        ...
        var claims = new[]
        {
            new Claim(ClaimTypes.Email, "gregory.ba.95@gmail.com"),
            new Claim(ClaimTypes.Name, "gregorybaranowski.com")
        };
